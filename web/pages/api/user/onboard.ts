    ...
    try {
        if (req.method === 'POST') {
            ...
            if (
                ...
                isNaN(parseInt(activityLevel)) ||
                parseInt(activityLevel) < 0 ||
                parseInt(activityLevel) > 4
            ) {
            ...
            if (
                !weeklyGoal ||
                isNaN(parseFloat(weeklyGoal)) ||
                parseFloat(weeklyGoal) < 0.25 ||
                parseFloat(weeklyGoal) > 1
            ) {
